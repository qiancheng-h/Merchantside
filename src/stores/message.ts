...
const mockMessages: MessageItem[] = [
  {
    ...
    type: 'approval',
    title: '您的服务审批已通过',
    summary: '您提交的体检服务「五星体检-不限-门诊体检」已审批通过，服务已上线生效。',
    content: '您提交的体检服务「五星体检-不限-门诊体检」已审批通过，服务已上线生效。',
  ...
  },
  {
    ...
    summary: '您提交的体检服务「三星体检-不限-门诊体检」审批被驳回，驳回原因：价格设置超出平台限制（最高¥500），请调整后重新提交。',
    content: '您提交的体检服务「三星体检-不限-门诊体检」审批被驳回，驳回原因：价格设置超出平台限制（最高¥500），请调整后重新提交。',
